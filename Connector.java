...
public class Connector {
	...
	public static void main(String[] args) {
		...
		if(slowStart) {
			...
			while(i < ssthresh && slowStart == true) {
			...
			System.out.print("cwnd: " + i);
		}
		
		
		
//		if (i > 2 && slowStart == true) {
//			while(j < ssthresh) {
//			int tempj = j*2;
//			
//			transferData(packets, i, result, lost, dupAckCounter);
...
//		}
		...
		for (int i = 0; i < packets.length; i++) {
			System.out.println("PACKET # " + i + " : ESTABLISHING CONNECTION: " + "SEQ: " + packets[i].getSeqNum()
					+ " ACK:" + packets[i].getackNum() + " DATA: " + packets[i].getData());
	...
	/**
	 * 
	 * @param packet array of all packets
	 * @param i      index of packet from array
	 */
